...
function speak () {
  setTimeout(() => playByText("en-US", "Welcome"), 300)
}
...
async function  converstationAssistantAdd(response){
...
async function openai_test(){
    ...
    let data = {model:"gpt-3.5-turbo", messages:conversationhistory}
  ...
  if (response.ok) {
    ...
    converstationAssistantAdd(message);
    console.log(message);
